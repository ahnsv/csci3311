...
def appendix_10(figure_counter: int):
    """Section 10 – Data Appendix with interactive filters and visualizations."""
    
    st.markdown("""
    ## College Data Explorer: Interactive Analysis Tool
    
    This interactive tool allows you to explore college affordability data across different years, states, and institution types.
    Use the filters below to customize your view and explore trends in tuition, debt, earnings, and return on investment.
    """)
        ...
        with st.spinner("Fetching data from College Scorecard API..."):
            try:
                ...
                for metric in selected_metrics:
                    ...
                    st.caption(f"Figure {figure_counter}: Time series of {metric_options[metric].lower()} by institution type.")
                    figure_counter += 1
